...
export function buildNextEventFlexMessage(
  weekId: string,
  weekData: Awaited<ReturnType<typeof getWeekData>>,
): LineFlexMessage {
          ...
          contents: [
            {
              type: "image",
              url:
                talk.presenterAvatar ||
                "https://mini-lt.lumos-ynu.jp/images/miniLT.jpg",
              size: "full",
              aspectMode: "cover",
              aspectRatio: "1:1",
              gravity: "center",
