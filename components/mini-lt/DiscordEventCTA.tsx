  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-3 justify-between">
      <Link
        ...
        className="bg-[#5865F2] hover:bg-[#4752C4] text-white px-6 py-2.5 rounded-lg font-bold transition-all hover:scale-105 flex items-center gap-2 shadow-md hover:shadow-lg whitespace-nowrap"
      >
