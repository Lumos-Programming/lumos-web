...
export function LiquidSplashEffect({ width, height, onComplete }: LiquidSplashEffectProps) {
  ...
  useEffect(() => {
    ...
    function tickFrame(timestamp: number) {
      ...
      for (const blob of blobs) {
        ...
        const spreadT = Math.max(0, Math.min(1, (animFrame - blob.stagger * SPREAD_END) / SPREAD_END))
