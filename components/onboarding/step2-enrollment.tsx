...
interface Step2EnrollmentProps {
  ...
  setStep2Errors: Dispatch<SetStateAction<Partial<Record<keyof FormData, string>>>>
  submitting: boolean
  onNext: () => void
  onBack: () => void
}

export function Step2Enrollment({form, setFormStep2, step2Errors, setStep2Errors, submitting, onNext, onBack}: Step2EnrollmentProps) {
  return (
    <div className="p-8">
