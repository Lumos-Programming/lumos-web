      ...
      <div className="space-y-4 animate-[fadeInUp_300ms_60ms_ease_both]">
        ...
        >
          <div className="min-w-0">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              {allowPublic
                ? "Lumosメンバーとして公式HPにメンバー情報を掲載できます"
                : "公式HPにメンバー情報を掲載しません"}
            </p>
          </div>
          <div
        ...
        <div className="space-y-1">
          ...
          {VISIBILITY_DISPLAY_KEYS.map((key) => {
            if (key === "currentOrg" && form.memberType !== "卒業生")
              return null;
            return (
              <div
                key={key}
              ...
              >
                ...
                <VisibilityToggle
                  ...
                  min={
                    key === "line" || key === "discord" ? "internal" : undefined
                  }
                />
              </div>
            );
