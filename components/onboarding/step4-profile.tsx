      ...
      <div className="space-y-6 animate-[fadeInUp_300ms_60ms_ease_both]">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-start gap-2 rounded-lg bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800 px-3 py-2">
            <Star
              className="w-3.5 h-3.5 text-purple-500 dark:text-purple-400 mt-0.5 flex-shrink-0"
              fill="currentColor"
            />
            <p className="text-xs text-purple-700 dark:text-purple-300">
              最大{MAX_TOP_INTERESTS}
              つまでメンバー一覧に表示できます。タグをタップして入れ替えできます。
            </p>
          </div>
          <InterestTagInput
            ...
            onTopInterestsChange={(top) =>
              setForm((f) => ({ ...f, topInterests: top }))
            }
          />
        </div>
