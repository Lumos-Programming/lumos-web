import type {MemberType, EnrollmentType, VisibilityLevel} from "@/types/profile"
...
export const FIELD_WEIGHTS: Partial<Record<keyof FormData | "line" | "github" | "x" | "visibility" | "faceImage", number>> = {
  lastName: 8,
  firstName: 8,
  studentId: 8,
  birthDate: 4,
...
export const STEP_LABELS_BASE = ["基本情報", "所属情報", "SNS連携", "プロフィール", "公開設定", "顔写真"]
