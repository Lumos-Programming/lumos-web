...
interface Step7AvatarProps {
  ...
  setPrimaryAvatar: Dispatch<SetStateAction<"face" | "discord" | "line" | "default">>
...
export function Step7Avatar({
  form, faceImageUrl, primaryAvatar, setPrimaryAvatar, ringColor,
  discordId, discordAvatar, lineLinked, lineAvatar,
  onbExternalPreview, submitting, onComplete, onBack,
}: Step7AvatarProps) {
  return (
    <div className="p-8">
