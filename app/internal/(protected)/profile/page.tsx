...
export default async function ProfilePage() {
  ...
  const social: Member["social"] = member
    ? {
        ...
        discordUsername:
          member.discordUsername || member.discordHandle || undefined,
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-6">
                ...
                {(member.lastNameRomaji || member.firstNameRomaji) && (
                  <div>
                    ...
                    <p className="text-sm font-medium mt-0.5">
                      {`${member.lastNameRomaji || ""} ${member.firstNameRomaji || ""}`.trim()}
                    </p>
                  </div>
                )}
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm font-medium mt-0.5">
                    {member.enrollments?.find((e) => e.isCurrent)?.faculty ||
                      "未設定"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm font-medium mt-0.5">
                    {member.yearByFiscal?.[String(new Date().getFullYear())] ||
                      "未設定"}
                  </p>
                </div>
                <div>
                ...
                {member.memberType === "卒業生" &&
                  (() => {
                    const gradYear = member.enrollments?.find(
                      (e) => e.isCurrent,
                    )?.graduationYear;
                    return gradYear ? (
                      <div>
