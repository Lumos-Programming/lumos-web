...
export const RING_COLORS = [
  { key: "purple", label: "パープル", ring: "ring-purple-400", bg: "bg-purple-400" },
  { key: "blue",   label: "ブルー",   ring: "ring-blue-400",   bg: "bg-blue-400" },
  { key: "green",  label: "グリーン", ring: "ring-green-400",  bg: "bg-green-400" },
  { key: "pink",   label: "ピンク",   ring: "ring-pink-400",   bg: "bg-pink-400" },
  { key: "orange", label: "オレンジ", ring: "ring-orange-400", bg: "bg-orange-400" },
  { key: "red",    label: "レッド",   ring: "ring-red-400",    bg: "bg-red-400" },
  { key: "teal",   label: "ティール", ring: "ring-teal-400",   bg: "bg-teal-400" },
  { key: "amber",  label: "アンバー", ring: "ring-amber-400",  bg: "bg-amber-400" },
  { key: "rose",   label: "ローズ",   ring: "ring-rose-400",   bg: "bg-rose-400" },
  { key: "indigo", label: "インディゴ", ring: "ring-indigo-400", bg: "bg-indigo-400" },
] as const
