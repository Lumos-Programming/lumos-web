...
variable "cloud_run_env_vars" {
  ...
  default = {
    dev = {
      ...
      ADMIN_ROLE_ASSIGN_DEFAULT_ROLE_ID      = ""
      ADMIN_ROLE_ASSIGN_DEFAULT_JOINED_AFTER = ""
    ...
    prd = {
      ...
      ADMIN_ROLE_ASSIGN_DEFAULT_ROLE_ID      = "1501185602756808804"
      ADMIN_ROLE_ASSIGN_DEFAULT_JOINED_AFTER = "2026-05-06T00:00:00+09:00"
